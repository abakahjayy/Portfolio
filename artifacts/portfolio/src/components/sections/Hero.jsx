    ...
    >
      ...
      <Container maxW="container.xl" position="relative" zIndex={1}>
        <Flex direction={{ base: "column-reverse", lg: "row" }} align="center" justify="space-between" gap={12}>
          ...
          <Box flex={1} maxW="2xl" minW={0} w="full" as={motion.div} style={{ y, opacity }}>
            <motion.div
              initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            >
              <Flex align="center" gap={3} mb={6} display="inline-flex" px={4} py={2} borderRadius="full" bg="panel" border="1px solid" borderColor="borderBase" maxW="full">
                <motion.div
                  animate={{ rotate: [0, 14, -8, 14, -4, 10, 0, 0] }}
                  transition={{ duration: 2.5, repeat: Infinity, repeatDelay: 1 }}
                  style={{ display: "inline-block", originX: 0.7, originY: 0.7, flexShrink: 0 }}
                >
                  <FaHandSparkles color="#eab308" size={20} />
                </motion.div>
                <Text fontWeight="600" color="textBase" fontSize={{ base: "xs", md: "sm" }} letterSpacing="wide" textTransform="uppercase" lineHeight="1.4" whiteSpace="normal">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
              <Heading 
                as="h1" fontSize={{ base: "4xl", sm: "5xl", md: "7xl" }} fontWeight="800" 
                lineHeight={{ base: "1.3", md: "1.15" }} fontFamily="heading" mb={4}
                pt={1}
              >
                Building Powerful{" "}
